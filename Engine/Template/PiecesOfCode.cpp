...
namespace PiecesOfCode
{
	...
	const std::string TArray_Struct =
	...
	const std::string FString_Struct =
		"struct FString\n"
		"{\n"
		"public:\n"
		"\tusing ElementType = const wchar_t;\n"
		...
		"\t\t\tconst std::string str(wideStr.begin(), wideStr.end());\n"
		"\t\t\treturn str;\n"
		"\t\t}\n"
		"\n"
	...
	const std::string UField_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UEnum_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UConst_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UProperty_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UStruct_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UFunction_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UStructProperty_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UObjectProperty_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";
	...
	const std::string UBoolProperty_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";

	const std::string UArrayProperty_Fields = "\t//REPLACE ME IN PiecesOfCode.cpp";
